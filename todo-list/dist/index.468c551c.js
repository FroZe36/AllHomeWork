...
root.append(_root.bigWrapper);

},{"./root":"fWkZV"}],"fWkZV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "bigWrapper", ()=>_action.bigWrapper
);
var _action = require("./action");
var _todo = require("./todo");
// ----------------- Functions -----------------
const createTodo = (todos)=>{
    const text = _action.addTodoTextField.value;
    const todoObject = {
    ...
    const todo = _todo.getTodo(todoObject, length - 1, todos);
    _action.bigWrapper.append(todo);
    _action.addTodoTextField.value = '';
    _todo.saveTodos(_todo.todosDB);
};
_action.addTodoButton.addEventListener('click', ()=>createTodo(_todo.todosDB)
);
const deleteAll = ()=>{
    const todoItems = document.querySelectorAll('.todo-item');
    _todo.todosDB.splice(0, _todo.todosDB.length);
    todoItems.forEach((item)=>item.remove()
    );
    _todo.saveTodos(_todo.todosDB);
};
_action.deleteAllButton.addEventListener('click', deleteAll);
_action.wrapperRow.append(_action.deleteAllButton, _action.addTodoTextField, _action.addTodoButton);
_action.bigWrapper.append(_action.wrapperRow, ..._todo.transformedTodos);

},{"./action":"9sSsz","./todo":"kc0n6","@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}],"9sSsz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"kc0n6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getTodo", ()=>getTodo
);
parcelHelpers.export(exports, "todosFromStorage", ()=>todosFromStorage
);
parcelHelpers.export(exports, "todosDB", ()=>todosDB
);
parcelHelpers.export(exports, "transformedTodos", ()=>transformedTodos
);
parcelHelpers.export(exports, "saveTodos", ()=>saveTodos
);
// ----------------- Todos and LocalStorage ----------------
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}]},["3ibEg","b9BDZ"], "b9BDZ", "parcelRequire5b66")
